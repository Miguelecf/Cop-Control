...
public class Mapa {
	...
	public Mapa(PistaDoble pistaDoble) {
		this.avionesEnAire = new ArrayList<Avion>();
		this.setPistas(pistaDoble);
		this.dimension = 500;
	}
	...
	public Posicion generarPosicionExtremoAlAzar() {
		...
		// Valor random entre 0 y Dimension, ambos incluidos para crear Posicion
		// Extremo.
		Integer enteroAlAzarEntreCeroYDimension = (int) Math
				.floor(Math.random() * (MaximoDimension - MinimoDimension + 1) + MinimoDimension);
